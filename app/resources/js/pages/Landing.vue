    ...
    <Layout title="Welcome">
        ...
        <Form method="post" class="flex flex-col place-content-evenly" v-slot="{ errors, processing }">
            <div class="relative flex flex-col justify-center items-center">
                ...
                <div v-if="errors.link" class="absolute flex items-center gap-1 text-sm text-red-500 -bottom-6">
            ...
            <button type="submit" class="flex gap-2 justify-center items-center bg-red-800/70 rounded-full text-2xl py-2 hover:bg-red-800/50 active:bg-red-950/70 transition-all ease-out duration-100 disabled:bg-red-950/70" :disabled="processing">
