...
<template>
    <div class="flex flex-col grow md:grow-0 place-content-evenly gap-8 md:gap-0">
        <div class="relative flex flex-col items-center">
            <template v-if="success">
                <Check strokeWidth="1" class="absolute bottom-8 md:bottom-5 w-30 h-30 text-green-600" />
                <p class="relative flex flex-col md:flex-row items-center text-xl pt-20">
                    <div class="text-amber-400 max-w-dvw px-5 md:px-0 md:max-w-xl truncate">
                        {{ fileName }}
                    </div>
                    &nbsp;is ready !
                </p>
            ...
            <template v-else>
                ...
                <p class="text-xl pt-20 text-center">Something went wrong ...</p>
                <Popover>
                    <PopoverTrigger as-child>
                        <button class="absolute -bottom-18 py-2 px-5 border-2 border-zinc-700 hover:bg-zinc-700 active:bg-zinc-700 rounded-md cursor-pointer transition-all ease-out duration-100">
                            Show error
                        </button>
                    </PopoverTrigger>
                    <PopoverContent class="md:w-175 max-h-50 flex border-2 border-red-800 bg-zinc-950 p-0">
                        <p class="overflow-auto p-4">
                            {{ error }}
                        </p>
                    </PopoverContent>
                </Popover>
        ...
        <!-- <div class="relative"> -->
            <div class="flex flex-col items-center gap-3" :class="success ? '' : 'hidden md:block md:invisible'">
                ...
                <p class="text-zinc-500 text-center">The download should start automatically</p>
            </div>
